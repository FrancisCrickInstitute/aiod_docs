...
**TODO: OVERALL FIGURE HERE**


This documentation covers how to setup and use the framework, providing information for the main different user groups of AIoD:
...
**TODO: Grid cards or something for diff models avail, with note on expandability**
...
**TODO: Table of repositories with links, and (in future) shields.io badge with version tag**
<!-- <table>
 <tr>
